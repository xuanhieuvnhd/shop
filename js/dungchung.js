	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a href="https://www.facebook.com/hoanghieuvnhd" class="fa fa-facebook"></a>
                <a href="https://twitter.com/hoanghieuhd" class="fa fa-twitter"></a>
                <a href="https://www.google.com.vn/" class="fa fa-google"></a>
                <a href="https://www.youtube.com/watch?v=1GO3Spvm7xI&list=PLwsfJw9e2abFbuLzLTybKoFAZknV-DHeu" class="fa fa-youtube"></a>
	...
	<div class="header group">
        <div class="logo">
            <a href="https://codegym.vn/">
                <img src="img/logo.jpg" alt="Trang chủ Codegym" title="Trang chủ Codygym">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">HOÀNG HIỂU STORE</a> - All rights reserved © 2022 - Designed by
            <span style="color: #eee; font-weight: bold">Group Nhóm 6 - Lớp : C0422H1</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <br>Hotline: 0986886222 <a href="tel:0986886222" style="color: #d6287f;">Gọi ngay</a>
                </li>
            </ul>
        </section>
    </div>`);
